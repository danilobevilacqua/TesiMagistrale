...
* all'interno di Unity, aprire la cartella Script del progetto;
...
* all'interno di Unity, navigare la gerarchia di oggetti cliccando su Canvas, poi su LanguageSelectionGroup e infine su Dropdown;
...
In alternativa anzichè modificare il file lo si può sostituire con quello già modificato, scaricabile da [qui](https://github.com/danilobevilacqua/TesiMagistrale/blob/main/Point%20AR/mutante%202/translate.cs). Per eseguire gli script di test sul mutante, basterà seguire quanto descritto precedentemente.
